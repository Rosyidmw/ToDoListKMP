...
fun DisplayTasks(
    ...
    if (showDialog) {
        AlertDialog(
            title = {
                Text(text = "Hapus", fontSize = MaterialTheme.typography.titleLarge.fontSize)
            },
            text = {
                Text(
                    text = "Kamu yakin ingin menghapus '${taskToDelete!!.title}' ini?",
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Text(
            ...
            text = if (showActive) "Tugas Aktif" else "Tugas Selesai",
